 ...
 */
public class ActivitySleGames extends Activity implements View.OnClickListener, ResponseLis ,Tps515PrintCall{
    ...
    private String responseString515 = "";
    private String resquestedMethod515 = "";
...
//            txt_away2, txt_away3, txt_away4, txt_away5, txt_away6, txt_away7, txt_away8, txt_away9, txt_away10, txt_away11, txt_away12, txt_away13;
    ...
    ImageView ebet_btn, btn_refresh, draw_btn, ola_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TpsGamesClass.getInstance().setFrontScreenLogicStarted();
        ...
        if (TpsGamesClass.getInstance().getDeviceName().contains("550") || TpsGamesClass.getInstance().getDeviceName().contains("hdx053")) {
            ...
            setContentView(R.layout.layout_dge_tps);
        }
        sport_btn = (ImageView) findViewById(R.id.sport_btn);
        currentGame = TpsGamesClass.getInstance().getGameSle("soccer13");
        initialize();
        TpsGamesClass.getInstance().setActivitySleGames(this);
...
//        }
        ...
        if (TpsGamesClass.getInstance().getDeviceName().contains("550") || TpsGamesClass.getInstance().getDeviceName().contains("hdx053")) {
            ...
            mainviewToadd = inflater.inflate(R.layout.layout_sports_tousie, null);
        } else {
            mainviewToadd = inflater.inflate(R.layout.layout_sports, null);
        }
        mainviewToadd.setLayoutParams(param);
        main_view.removeAllViews();
        main_view.addView(mainviewToadd);
        if (TpsGamesClass.getInstance().getDeviceName().contains("PT7003") && PrintActivityAllGamesTousei.printTouseiBoolean) {
            Bitmap bitmap1 = BitmapFactory.decodeResource(ActivitySleGames.this.getResources(), R.drawable.soccerthirteen_tousei);
    ...
    protected void onResume() {
        super.onResume();
        sport_btn.setImageResource(R.mipmap.sportsselect);
        TpsGamesClass.getInstance().setCurrentActivity("sle");
        if (TpsGamesClass.getInstance().getDeviceName().contains("7003")) {
            if (!PrintActivityAllGamesTousei.printTouseiBoolean) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        TpsGamesClass.getInstance().changeBackScreen(selectedGame);
                    }
                }, 2000);

                PrintActivityAllGamesTousei.printTouseiBoolean = true;
            }
        }
        String balance = TpsGamesClass.getInstance().getLoginResponse().getData().getAvailableBalance() + "";
...
//        }
    ...
    protected void initialize() {
        ...
        ebet_btn = (ImageView) findViewById(R.id.ebet_btn);
        ...
        ola_btn.setOnClickListener(this);
        ...
        bet_slip.setOnClickListener(this);
    ...
    protected void setGame() {
        ...
        if (lastGameSelectedIndex == 0) {
            ...
            if (TpsGamesClass.getInstance().getDeviceName().contains("550") || TpsGamesClass.getInstance().getDeviceName().contains("hdx053")) {
                ...
                mainviewToadd = inflater.inflate(R.layout.layout_sports_soccer6, null);
...
//                }
        ...
        if (TpsGamesClass.getInstance().getDeviceName().contains("PT7003") && PrintActivityAllGamesTousei.printTouseiBoolean) {
            if (currentGame.getGameTypeDevName().contains("13")) {
                Bitmap bitmap1 = BitmapFactory.decodeResource(ActivitySleGames.this.getResources(), R.drawable.soccerthirteen_tousei);
                TpsGamesClass.getInstance().displayImagebyAbsolutePath("", bitmap1);
                selectedGame = 13;
            } else if (currentGame.getGameTypeDevName().contains("6")) {
                Bitmap bitmap1 = BitmapFactory.decodeResource(ActivitySleGames.this.getResources(), R.drawable.soccersix_tousei);
                TpsGamesClass.getInstance().displayImagebyAbsolutePath("", bitmap1);
                selectedGame = 6;
            }
        }
        ...
        if (TpsGamesClass.getInstance().getDeviceName().contains("TPS580") && currentGame != null) {
...
//            TpsGamesClass.getInstance().showAToast("Amount = " + amount + "\n betMul = " + betAmtMul, ActivityDgeGames.this, Toast.LENGTH_LONG);
...
//                            game_selector_normal
                ...
                showOtherDialog(ActivitySleGames.this);
...
//                    TpsGamesClass.getInstance().showAToast("Device has No Camera", ActivitySleGames.this, Toast.LENGTH_SHORT);
//                    return;
//                }
                if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {

                    intent = new Intent(ActivitySleGames.this, ClaimWinningActivityTousei.class);
                    intent.putExtra("selectedPosition", selectedGame);
                    ...
                    intent = new Intent(ActivitySleGames.this, ClaimWinningActivity.class);
                    startActivityForResult(intent, 055);
                    break;
                }
            ...
            case R.id.ebet_btn:
                if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {
                    Intent intent = new Intent(ActivitySleGames.this, ActivityEbetSlipTpsGame.class);
                    intent.putExtra("selectedPosition", selectedGame);
                    startActivity(intent);
                } else
                    startActivityForResult(new Intent(ActivitySleGames.this, ActivityEbetSlipTpsGame.class), 001);
                break;
            case R.id.common_bet_slip_btn:
                if (TpsGamesClass.getInstance().getDeviceName().contains("550") || TpsGamesClass.getInstance().getDeviceName().contains("hdx053") || (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003"))) {
                    new AlertDialog.Builder(ActivitySleGames.this)
                ...
                TpsGamesClass.getInstance().setCameraOpen(true);
                startActivityForResult(new Intent(ActivitySleGames.this, ActivityBetSlipCamera.class), 056);
                break;
            case R.id.bet_slip:
                if (horizontalScroll instanceof HorizontalScrollView)
                    ((HorizontalScrollView) horizontalScroll).fullScroll(HorizontalScrollView.FOCUS_RIGHT);
                else
                    ((ScrollView) horizontalScroll).fullScroll(View.FOCUS_DOWN);
                break;
            ...
            case R.id.ola_btn:
                TpsGamesClass.getInstance().closeScreen(this);
                startActivityForResult(new Intent(ActivitySleGames.this, Ola.class), 001);
                break;
        }
    }

    protected void moveToLogin() {
        Intent intent = new Intent(ActivitySleGames.this, LoginActivityTpsGame.class);
    ...
    private void serverRequestCall(String serverRequest, String requestServer) {
        if (serverRequest != null && serverRequest.equalsIgnoreCase(ConstantField.ONETOTWELVE)) {
            ...
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivitySleGames.this, "oneTwoTwelve", ActivitySleGames.this, "TwleveByTwenty");
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
            ...
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivitySleGames.this, "TwleveByTwenty", ActivitySleGames.this, "TwleveByTwenty");
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
            ...
            String url = TpsGamesClass.getInstance().getTicketSaleServicesForSle(ActivitySleGames.this, TpsGamesClass.getInstance().getLoginResponse().getData().getRetailerName()
...
//                url = url + "&tokenId=" + responseData.getTokenId();
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivitySleGames.this, "ebet slip", ActivitySleGames.this, "sports", null);
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.hasExtra("resetRequest")) {
            ...
            if (TpsGamesClass.getInstance().getDeviceName().contains("7003"))
                Communcations.winningInside(ActivitySleGames.this, data.getStringExtra("message"), selectedGame);
            else
                Communcations.winningInside(ActivitySleGames.this, data.getStringExtra("message"));
            ...
            if (TpsGamesClass.getInstance().getDeviceName().contains("rk30")) {
                intent = new Intent(ActivitySleGames.this, PrintWinningAzt.class);
            } else if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("P01M")) {
                intent = new Intent(ActivitySleGames.this, ActivityBluetoothPrint.class);
            } else if (TpsGamesClass.getInstance().getDeviceName().contains("7003")) {
                intent = new Intent(ActivitySleGames.this, PrintWinningClaimTousei.class);
            } else {
                intent = new Intent(ActivitySleGames.this, PrintWinningClaim.class);
            }
...
//        TpsGamesClass.getInstance().openCard();
        ...
        if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003"))
            winnigDialog.setMessages("Enter Your Weaver Card no. or Mobile no.");
        else
        ...
        Bitmap bitmap1 = BitmapFactory.decodeResource(ActivitySleGames.this.getResources(), R.drawable.banner_tousei);
        TpsGamesClass.getInstance().displayImagebyAbsolutePath("Enter Your Mobile number or Weaver Card number.", bitmap1);
        winnigDialog.show();
        if (TpsGamesClass.getInstance().getDeviceName().contains("7003")) {
            winnigDialog.setOnKeyListener(new Dialog.OnKeyListener() {
...
//        TpsGamesClass.getInstance().displayScreen(this);
        ...
        HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivitySleGames.this, "verifyUser", ActivitySleGames.this, "rgCall", Utility.rGGamingHeader);
        TpsGamesClass.getInstance().startLoader(this);
    ...
    View.OnClickListener positiveClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (winnigDialog.getEditTextValue().trim().length() > 0) {
                ...
                TpsGamesClass.getInstance().showAToast("Please Enter Some Value", ActivitySleGames.this, Toast.LENGTH_SHORT);
            }
        }
    };
    ...
    public void onResponse(String response, String requestedMethod) {
        ...
        try {
            ...
            if (jsonObject == null) {
                ...
                moveToLogin();
                //  }
                TpsGamesClass.getInstance().showAToast("No data available!", ActivitySleGames.this, Toast.LENGTH_SHORT);
                return;
            } else if ((jsonObject.has("isSuccess") && jsonObject.optBoolean("isSuccess") == false)) {
                //   if (ServerCommClass.getServerCommClass().getFragmentActivity() == null) {
                moveToLogin();
                //  }
                TpsGamesClass.getInstance().showAToast(jsonObject.optString("errorMsg"), ActivitySleGames.this, Toast.LENGTH_SHORT);
                return;
            } else if (jsonObject.has("responseCode") && jsonObject.optString("responseCode").equals("500")) {
                //  if (ServerCommClass.getServerCommClass().getFragmentActivity() == null) {
                moveToLogin();
                //  }
                TpsGamesClass.getInstance().showAToast(jsonObject.optString("responseMsg"), ActivitySleGames.this, Toast.LENGTH_SHORT);
                return;
            }
        } catch (JSONException e) {
            e.printStackTrace();
        ...
        if (response.equalsIgnoreCase("failed")) {
            ...
            moveToLogin();
            //   }
            TpsGamesClass.getInstance().showAToast("Server Error", ActivitySleGames.this, Toast.LENGTH_SHORT);
            return;
        }
        if (response.equalsIgnoreCase("ErrorMsg:Time Out, Login Again!!|ErrorCode:01|")) {
            TpsGamesClass.getInstance().showAToast("Time Out, Login Again!!", ActivitySleGames.this, Toast.LENGTH_SHORT);
            moveToLogin();
            return;
        }

        if (response.contains("login again")) {
            TpsGamesClass.getInstance().showAToast("Timer Out", ActivitySleGames.this, Toast.LENGTH_SHORT);
            moveToLogin();
            finish();
            return;
        }
        if (response.contains("<HTML>")) {
            TpsGamesClass.getInstance().showAToast("Connect to internet", ActivitySleGames.this, Toast.LENGTH_SHORT);
            moveToLogin();
            finish();
            return;
        }
        if (response.contains("<html>") || response.contains("<!DOCTYPE HTML PUBLIC")) {
            TpsGamesClass.getInstance().showAToast("Server not sending correct data", ActivitySleGames.this, Toast.LENGTH_SHORT);
            moveToLogin();
            finish();
            return;
        }
        if (requestedMethod.equalsIgnoreCase("fail")) {
            ...
            TpsGamesClass.getInstance().getActivityDgeGames().resetEveryThing();
            onBackPressed();
...
//            PLAYERBALANCE = getIntent().getStringExtra("playerBalance") != null ? getIntent().getStringExtra("playerBalance") : ""
            ...
            if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {
                intent = new Intent(ActivitySleGames.this, PrintActivityAllGamesTousei.class);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            } else if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("TPS515")) {
                resquestedMethod515 = requestedMethod.toString();
                responseString515 = response;
                ...
                intent = new Intent(ActivitySleGames.this, PrintActivityAZT.class);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            } else {
                intent = new Intent(ActivitySleGames.this, PrintActivityAllGames.class);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            }
...
//            }
            ...
            if (response.contains("ErrorCode")) {
                TpsGamesClass.getInstance().showAToast(response.substring(response.indexOf(":") + 1, response.indexOf("|")), ActivitySleGames.this, Toast.LENGTH_SHORT);
                return;
            }
            //ErrorMsg
            if (response.contains("ErrorMsg")) {
                TpsGamesClass.getInstance().showAToast(response.substring(response.indexOf(":") + 1, response.length()), ActivitySleGames.this, Toast.LENGTH_SHORT);
                return;
            }
            Intent intent = null;
            if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("TPS515")) {
                ...
                if (TpsGamesClass.getInstance().getDeviceName().contains("rk30")) {
                intent = new Intent(ActivitySleGames.this, PrintActivitySportsAzt.class);
            } else if (TpsGamesClass.getInstance().getDeviceName().contains("7003")) {
                intent = new Intent(ActivitySleGames.this, PrintActivitySportsGameTousei.class);
            } else {
                intent = new Intent(ActivitySleGames.this, PrintActivitySportsGame.class);
            }
                intent.putExtra("selectedPosition", selectedGame);
                intent.putExtra("response", response);
...
//                        }
    ...
    public void onUsbPermissionSuccess() {
        if(resquestedMethod515.equals("TwleveByTwenty")){
            intent = new Intent(ActivitySleGames.this, PrintActivityDgeExternalPrinter.class);
            intent.putExtra("response", responseString515);
            startActivityForResult(intent, 054);
        }else if(resquestedMethod515.equals("sports")) {
            intent = new Intent(ActivitySleGames.this, PrintActivitySportsExternal.class);
            intent.putExtra("selectedPosition", selectedGame);
            intent.putExtra("response", responseString515);
            startActivityForResult(intent, 59);
        }
