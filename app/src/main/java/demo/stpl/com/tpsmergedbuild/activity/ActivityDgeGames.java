 ...
 */
public class ActivityDgeGames extends Activity implements View.OnClickListener, ResponseLis,Tps515PrintCall {
    ...
    private String printResponseForTps515;

    int selectedPosition = -1, lastBetAmountPosition = 1, betTypeSelected = 1;
    ImageView list_icon, pick_down, pick_up, btn_refresh, ebet_btn, sport_btn, ola_btn;
    ...
    private String requestedMethod515 = "";
...
//        game_name.setAdapter(recyclerViewAdapter);
        ...
        TpsGamesClass.getInstance().setActivityDgeGames(this);
...
//            if(packageInfo.packageName.equals("demo.stpl.com.tpsmergedbuild")){
...
//        TpsGamesClass.getInstance().openCard();
        ...
        if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003"))
            winnigDialog.setMessages("Enter Your Mobile number or Weaver Card number.");
        else
        ...
        if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")){
        bitmap1 = BitmapFactory.decodeResource(ActivityDgeGames.this.getResources(), R.drawable.banner_tousei);
    ...
    public synchronized void cardSwipeVerify(String playerId, String mobileNumber) {
        ...
        if(TpsGamesClass.getInstance().getDeviceName().contains("7003")){
        bitmap1 = BitmapFactory.decodeResource(ActivityDgeGames.this.getResources(), R.drawable.banner_tousei);
        TpsGamesClass.getInstance().displayImagebyAbsolutePath("Verifying Player...", bitmap1);}
...
//        TpsGamesClass.getInstance().displayScreen(this);
        ...
        HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivityDgeGames.this, "verifyUser", ActivityDgeGames.this, "rgCall", Utility.rGGamingHeader);
    ...
    View.OnClickListener positiveClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (winnigDialog.getEditTextValue().trim().length() > 0) {
                ...
                TpsGamesClass.getInstance().showAToast("Please Enter Some Value", ActivityDgeGames.this, Toast.LENGTH_SHORT);
            }
        }
    };
...
//            ServerCommClass.getServerCommClass().getOnKeyListener().onFragmentChange();
    ...
    private void serverRequestCall(String serverRequest, String requestServer) {
        if (serverRequest != null && serverRequest.equalsIgnoreCase(ConstantField.ONETOTWELVE)) {
            ...
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivityDgeGames.this, "oneTwoTwelve", ActivityDgeGames.this, "TwleveByTwenty");
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
            ...
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivityDgeGames.this, "TwleveByTwenty", ActivityDgeGames.this, "TwleveByTwenty");
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
            ...
            String url = TpsGamesClass.getInstance().getTicketSaleServicesForSle(ActivityDgeGames.this, TpsGamesClass.getInstance().getLoginResponse().getData().getRetailerName()
...
//                url = url + "&tokenId=" + responseData.getTokenId();
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivityDgeGames.this, "ebet slip", ActivityDgeGames.this, "SaleSports", null);
            TpsGamesClass.getInstance().startLoader(this);
            httpRequest.executeTask();
        }
    }

    public String getDataFormat(String data) {
//        17-10-2016 06:40:00
...
//            }
            if (isFortune) {
                ...
                linearLayout.setOnClickListener(ActivityDgeGames.this);
                ...
                if (i < 27) {
                    ...
                    button.setOnClickListener(ActivityDgeGames.this);
...
//                linearLayout.setSelected(false);
                ...
                robotoCommonTextView.setOnClickListener(ActivityDgeGames.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data != null && data.hasExtra("resetRequest")) {
            ...
            if(TpsGamesClass.getInstance().getDeviceName().contains("7003"))
                Communcations.winningInside(ActivityDgeGames.this, data.getStringExtra("message"), selectedPosition);
            else
            Communcations.winningInside(ActivityDgeGames.this, data.getStringExtra("message"));
            ...
            if (TpsGamesClass.getInstance().getDeviceName().contains("rk30")) {
                intent = new Intent(ActivityDgeGames.this, PrintWinningAzt.class);
            } else if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("P01M")) {
                intent = new Intent(ActivityDgeGames.this, ActivityBluetoothPrint.class);
            }else if(TpsGamesClass.getInstance().getDeviceName().contains("7003")){
                intent = new Intent(ActivityDgeGames.this, PrintWinningClaimTousei.class);
            }
            else {
                intent = new Intent(ActivityDgeGames.this, PrintWinningClaim.class);
            }
    ...
    protected void changeCurrentSelectionGame() {
        ...
        if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003") && PrintActivityAllGamesTousei.printTouseiBoolean) {
    ...
    protected void onResume() {
        super.onResume();
        draw_btn.setImageResource(R.mipmap.drawssslect);
        TpsGamesClass.getInstance().setCurrentActivity("dge");
        if(TpsGamesClass.getInstance().getDeviceName().contains("7003")) {
...
//        }
    ...
    DrawDialog.TotalAmountOther totalAmountOther = new DrawDialog.TotalAmountOther() {
        ...
        public void otherAmount(double amount, int betAmtMul) {
            ActivityDgeGames.this.amountOther = amount;
            ActivityDgeGames.this.betAmtMul = betAmtMul;
...
//        quick_pick_number_layout_upper.setVisibility(View.INVISIBLE);
    ...
    protected void purchaseRequestMiniRoulette() {
        try {
            ...
            HttpRequest httpRequest = TpsGamesClass.getInstance().getHttpRequest(url, ActivityDgeGames.this, "TwleveByTwenty", ActivityDgeGames.this, "TwleveByTwenty");
            TpsGamesClass.getInstance().startLoader(ActivityDgeGames.this);
            httpRequest.executeTask();
...
//                            game_selector_normal
                ...
                if (selectedPosition != 2) {
                    showOtherDialog(ActivityDgeGames.this);
                }

                break;
            case R.id.draws:

                showDrawDialog(ActivityDgeGames.this, currentGame.getDraws());
                break;
            ...
            case R.id.common_winning_claim_btn:
                if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {
                    intent = new Intent(ActivityDgeGames.this, ClaimWinningActivityTousei.class);
                    intent.putExtra("selectedPosition", selectedPosition);
                    startActivityForResult(intent, 055);
                    break;
                } else {
//                    if (!TpsGamesClass.getInstance().getIfHasCamera()) {
//                        TpsGamesClass.getInstance().showAToast("Device has No Camera", ActivityDgeGames.this, Toast.LENGTH_SHORT);
//                        return;
//                    }
                    ...
                    intent = new Intent(ActivityDgeGames.this, ClaimWinningActivity.class);
                    startActivityForResult(intent, 055);
                    break;
                }
            case R.id.btn_refresh:
                ...
                break;
            case R.id.ebet_btn:
                Intent intent=new Intent(ActivityDgeGames.this, ActivityEbetSlipTpsGame.class);
                intent.putExtra("selectedPosition",selectedPosition);
                startActivity(intent);
                break;
            case R.id.common_bet_slip_btn:
                ...
                if (TpsGamesClass.getInstance().getDeviceName().contains("550") || TpsGamesClass.getInstance().getDeviceName().contains("hdx053") || (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003"))) {
                    new AlertDialog.Builder(ActivityDgeGames.this)
                ...
                if (!isOpenBetSlip) {
                    TpsGamesClass.getInstance().setCameraOpen(true);
                    startActivityForResult(new Intent(ActivityDgeGames.this, ActivityBetSlipCamera.class), 056);
                }
                break;
            case R.id.sport_btn:
                callSportData();
            ...
            case R.id.ola_btn:
                TpsGamesClass.getInstance().closeScreen(this);
                startActivityForResult(new Intent(ActivityDgeGames.this, Ola.class), 001);
                break;
            default:
                    ...
                    if (selectedPosition == 2) {
                        ...
                        if (v.getId() == totalView[i] || v.getId() == miniroulettechip[i]) {
                            ...
                            if ((currentbetamount + Integer.parseInt(selected.getText() + "")) <= games.getMaxBetAmtMul()) {
                                ...
                                TpsGamesClass.getInstance().showAToast("Max bet amount allowed on this bet is $" + currentGame.getBets()[lastBetAmountPosition].getMaxBetAmtMul(), ActivityDgeGames.this, Toast.LENGTH_SHORT);
                            }
                            v.setSelected(true);
                            break;
                        }
...
//                            R.drawable.game_selection_bg_pressed_new
                        ...
                        selected_numbers.setText(hashMap.size() + "");
//                        TpsGamesClass.getInstance().showAToast(((RobotoCommonTextView) v).getText().toString(), ActivityDgeGames.this, Toast.LENGTH_SHORT);
                        break;
                    }
                }
                if (selectedPosition == 1) {
    ...
    public void onResponse(String response, String requestedMethod) {
        ...
        try {
            ...
            if (jsonObject == null) {
                ...
                TpsGamesClass.getInstance().showAToast("No data available!", ActivityDgeGames.this, Toast.LENGTH_SHORT);
                return;
            } else if ((jsonObject.has("isSuccess") && jsonObject.optBoolean("isSuccess") == false)) {

                TpsGamesClass.getInstance().showAToast(jsonObject.optString("errorMsg"), ActivityDgeGames.this, Toast.LENGTH_SHORT);
                return;
            } else if (jsonObject.has("responseCode") && jsonObject.optString("responseCode").equals("500")) {

                TpsGamesClass.getInstance().showAToast(jsonObject.optString("responseMsg"), ActivityDgeGames.this, Toast.LENGTH_SHORT);
                return;
            }
        } catch (JSONException e) {
            e.printStackTrace();
        ...
        if (response.equalsIgnoreCase("failed")) {
            ...
            TpsGamesClass.getInstance().showAToast("Server Error", ActivityDgeGames.this, Toast.LENGTH_SHORT);
            return;
        }

        if (response.contains("login again")) {
            TpsGamesClass.getInstance().showAToast("Timer Out", ActivityDgeGames.this, Toast.LENGTH_SHORT);
            Intent intent = new Intent(ActivityDgeGames.this, TpsSplashActivity.class);
        ...
        if (response.contains("<HTML>")) {
            TpsGamesClass.getInstance().showAToast("Connect to internet", ActivityDgeGames.this, Toast.LENGTH_SHORT);
            Intent intent = new Intent(ActivityDgeGames.this, TpsSplashActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        if (response.contains("<html>") || response.contains("<!DOCTYPE HTML PUBLIC")) {
            TpsGamesClass.getInstance().showAToast("Server not sending correct data", ActivityDgeGames.this, Toast.LENGTH_SHORT);
            Intent intent = new Intent(ActivityDgeGames.this, TpsSplashActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//            PLAYERBALANCE = getIntent().getStringExtra("playerBalance") != null ? getIntent().getStringExtra("playerBalance") : ""
            ...
            if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {
                intent = new Intent(ActivityDgeGames.this, PrintActivityAllGamesTousei.class);
                intent.putExtra("selectedPosition", selectedPosition);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            } else if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("TPS515")) {
                requestedMethod515= requestedMethod.toString();
                TpsGamesClass.getInstance().setTps515PrintCall(this);
                printResponseForTps515 = response;
                TpsGamesClass.getInstance().checkUsbPrintPermission(ActivityDgeGames.this);
//                intent = new Intent(ActivityDgeGames.this, PrintActivityDgeExternalPrinter.class);
//                intent.putExtra("response", response);
//                startActivityForResult(intent, 054);
            } else if (TpsGamesClass.getInstance().getDeviceName().contains("rk30")) {
                TpsGamesClass.getInstance().setPrintResponseForAzt(response);
                intent = new Intent(ActivityDgeGames.this, PrintActivityAZT.class);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            } else {
                intent = new Intent(ActivityDgeGames.this, PrintActivityAllGames.class);
                intent.putExtra("response", response);
                startActivityForResult(intent, 054);
            }
//            if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("PT7003")) {
...
//            }
            ...
            if (totalError >= 2) {
                TpsGamesClass.getInstance().showAToast("No Data Available For Sports", ActivityDgeGames.this, Toast.LENGTH_SHORT);
                return;
            }
            Log.e("", "");
            TpsGamesClass.getInstance().closeScreen(this);
            ...
            intent = new Intent(ActivityDgeGames.this, ActivitySleGames.class);
...
//                        }
            ...
            if (response.contains("ErrorCode")) {
                TpsGamesClass.getInstance().showAToast(response.substring(response.indexOf(":") + 1, response.indexOf("|")), ActivityDgeGames.this, Toast.LENGTH_SHORT);
                return;
            }
            Intent intent = null;
            if (TpsGamesClass.getInstance().getDeviceName().equalsIgnoreCase("TPS515")) {
                ...
                if (TpsGamesClass.getInstance().getDeviceName().contains("rk30")) {
                    intent = new Intent(ActivityDgeGames.this, PrintActivitySportsAzt.class);
                }else if(TpsGamesClass.getInstance().getDeviceName().contains("7003")){
                    intent = new Intent(ActivityDgeGames.this, PrintActivitySportsGameTousei.class);
                }
                else {
                    intent = new Intent(ActivityDgeGames.this, PrintActivitySportsGame.class);
                }
                intent.putExtra("response", response);
...
//            }
    ...
    public void onUsbPermissionSuccess() {
        if(requestedMethod515.equals("SaleSports")){
            intent = new Intent(ActivityDgeGames.this, PrintActivitySportsExternal.class);
            intent.putExtra("response", printResponseForTps515);
            startActivityForResult(intent, 59);
        }else{
            intent = new Intent(ActivityDgeGames.this, PrintActivityDgeExternalPrinter.class);
            intent.putExtra("response", printResponseForTps515);
